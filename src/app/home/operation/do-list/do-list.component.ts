...
export class DoListComponent implements OnInit {
  ...
  getDOList() {
    ...
    this.dO.ORG_CODE = this._cs.getUserOrgCode();
    this.dO.PORT = this._cs.getUserPort();
    this.isLoading = true;
          ...
          table: {
            ...
            body: [
              ...
              [
                {},
                {
                  text: this.itemPdf.ORG_ADDRESS1,
                  bold: false,
                  fontSize: 9,
                  alignment: 'center',
                },
          ...
          table: {
            ...
            body: [
              [
                {
                  text:
                    this.itemPdf.IGM_NO == null || this.itemPdf.IGM_NO == ''
                      ? ''
                      : 'I.G.M.No./\nDate',
                  fontSize: 9,
                  bold: true,
      ...
      content: [
                  ...
                  text:
                    this.itemPdf.IGM_NO == null || this.itemPdf.IGM_NO == ''
                      ...
                      : this.itemPdf.IGM_NO +
                        '/ ' +
                        formatDate(
                          new Date(this.itemPdf.IGM_DATE),
                          'dd-MM-yyyy',
                          'en'
                        ),
                  fontSize: 9,
        ...
        },
        {
          text:
            ...
            this.itemPdf.CONSIGNEE +
            ' at your yard, after the necessary survey has been carried out by Surveyor.',
          bold: false,
          fontSize: 9,
          margin: [0, 0, 0, 10],
        },
